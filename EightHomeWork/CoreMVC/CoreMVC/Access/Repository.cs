namespace Api.Access
{
    ...
    public class Repository
    {
        ...
        public Repository(IOptions<Demo> options)
        {
...
",
        ...
        public void DeleteHomeTaskByCourseId(int courseId)
        {
            using (SqlConnection connection = GetConnection())
            {
                SqlCommand sqlCommand = new SqlCommand(
...
",
        ...
        public List<Course> GetStudentCourses(int studentId)//private
        {
            List<Course> result = new List<Course>();
            using (SqlConnection connection = GetConnection())
            {
             ...
             using (SqlConnection connection = GetConnection())
            {
              ...
              where Id =  {id}", connection);
                ...
                using (var reader = sqlCommand.ExecuteReader())
                {
                    ...
                    Student student = new Student() { Id = reader.GetInt32(3) };
                    result.Student  = student;
                    var hometask = new HomeTask() { Id = reader.GetInt32(4) };
